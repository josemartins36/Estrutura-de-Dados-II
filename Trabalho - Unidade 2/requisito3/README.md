...
Em contraste com a rede ODS 3, essa rede é menor e mais dispersa, apresentando o menor coeficiente de clustering das redes observadas. Destoando de todas as outras redes analisadas, essa apresenta um coeficiente de assortatividade negativo, implicando que nós de alto grau tendem a se conectar com nós de baixo grau e vice-versa. Assim, espera-se que seja uma rede de diversos grupos pequenos e com uma peculiar tendência de autores com alto número de colaboradores se associarem com os autores com baixo número de colaboradores.
